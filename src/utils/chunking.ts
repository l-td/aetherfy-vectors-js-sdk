 ...
 * `{"points":[…]}` array overhead. Conservative — empirical tests show
 * ~95 MB also passes, but the margin protects against framing surprises
 * (compressed transfer-encoding inflation, large headers, etc.).
 */
